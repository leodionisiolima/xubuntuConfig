...
#Instalar o cliente do fast.com
echo -e "${boldGreen}\nInstalando o cliente do fast.com:\n${reset}"
sudo npm install --global fast-cli || { echo -e "${boldRed}\nFalha ao instalar o fast-cli.\n${reset}"; exit 1; }
...
pip install gdown && \
gdown --folder https://drive.google.com/drive/u/0/folders/1FT_dPslCaaILpx_jVJvFZNRD_f-7zzrV && \
rsync -a --ignore-existing xfce4-settings/.config/xfce4/ ~/.config/xfce4/ || { echo -e "${boldRed}\nFalha ao baixar configurações do XFCE4 manager.\n${reset}"; exit 1; }
